...
***The reason it is sometimes better to choose median instead of mean is because if we take the mean the data can be thrown off by outliers such as the "ultra rich" who are making way more than what is expected for their degree, and by those who are barely making any income. The median will do the best job at showing the true middle income.***
...
***I used a binwidth of 5000 because a binwidth of 1000 made the columns too small and difficult to read***
...
***The histogram is skewed to the right, which means that the majority of the people represented in the chart have a lower income. The min, max, and median are the best summary statistics for representing this distribution because they work best to represent the x value we chose, 'median', for the chart.
min: The minimum value of the earnings.
max: The maximum value of the earnings.
med: The median value of the earnings.***
...
***my question- what is the relationship between a proportion of women in stem/not in stem and unemployment rate?*** 
```{r my-visualization}

ggplot(data = college_recent_grads, mapping = aes(x = sharewomen, y = unemployment_rate, color = major_type)) +
  geom_point(binwidth = 5000)
